...
thresholds3 = [(0, 0, 40, 73, 26, 57)]#ゴール（青色）
...
sensor.set_auto_whitebal(False,(-5.82073, -5.019987, 0.5176831))# must be turned off for color tracking
clock = time.clock()
...
while(True):  #メインループ
 ...
 cut_lef_and_rig=160#画面上での縦線の定義
 ...
 if areaA[1]==iwashi!=0:#ボールの色を整理　補足したブロックの密度で判別しソート
     ...
     img.draw_rectangle(rectA[2])#長方形の生成ynq4wtbeh fgnh
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[2])
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[3])
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[4])
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[5])
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[6])
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[7])
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[8])
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[9])
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[10])
 elif areaA[11]==iwashi!=0:
     img.draw_rectangle(rectA[11])#長方形の生成
     img.draw_cross(cyA[11], cyA[11]) #中央のバツの生成
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[11])
 elif areaA[12]==iwashi!=0:
     img.draw_rectangle(rectA[12])#長方形の生成
     img.draw_cross(cyA[12], cyA[12]) #中央のバツの生成
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[12])
 elif areaA[13]==iwashi!=0:
     img.draw_rectangle(rectA[13])#長方形の生成
     img.draw_cross(cyA[13], cyA[13]) #中央のバツの生成
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[13])
 elif areaA[14]==iwashi!=0:
     img.draw_rectangle(rectA[14])#長方形の生成
     img.draw_cross(cyA[14], cyA[14]) #中央のバツの生成
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[14])
 elif areaA[15]==iwashi!=0:
     img.draw_rectangle(rectA[15])#長方形の生成
     img.draw_cross(cyA[15], cyA[15]) #中央のバツの生成
     ...
     ch3 = tim1.channel(3, Timer.PWM, pin=Pin("P9"), pulse_width_percent=distanceA[15])
 else:
