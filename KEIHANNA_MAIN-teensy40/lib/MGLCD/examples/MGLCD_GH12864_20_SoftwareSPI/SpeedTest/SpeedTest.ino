...
#define WAIT      0
  ...
  static MGLCD_AQM1248A_SoftwareSPI MGLCD(MGLCD_SpiPin4(SCK_PIN, MOSI_PIN, CS_PIN, DI_PIN),WAIT);
#elif MGLCD_DEVICE==DEV_GH12864_20
  static MGLCD_GH12864_20_SoftwareSPI MGLCD(MGLCD_SpiPin4(SCK_PIN, MOSI_PIN, CS_PIN, DI_PIN),WAIT);
#else
