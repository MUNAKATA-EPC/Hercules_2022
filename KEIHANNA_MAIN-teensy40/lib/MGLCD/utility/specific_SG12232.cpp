...
uint8_t (*const specific_SG12232::GeneralReadData)(uint8_t ctrl, const TPinSet &PinSet) = ::GeneralReadData;
uint8_t (*const specific_SG12232::StandardReadData)(uint8_t ctrl, const TPinSet &PinSet) = ::StandardReadData;
void (*const specific_SG12232::GeneralWriteData )(uint8_t ctrl, uint8_t data, const TPinSet &PinSet) = ::GeneralWriteData;
void (*const specific_SG12232::StandardWriteData)(uint8_t ctrl, uint8_t data, const TPinSet &PinSet) = ::StandardWriteData;

void specific_SG12232::Reset(void)
{
