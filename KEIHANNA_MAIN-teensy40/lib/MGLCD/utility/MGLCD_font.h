/*
  ...
  MGLCD developed by Synapse from 2012 to 2016.  This Library is originally 
  distributed at Team Schaft's Homepage. <http://www3.big.or.jp/~schaft>
...
extern const uint8_t FontBmp1[][5];
extern const uint8_t FontBmp2[][5];
